...
<a href="http://www.amazon.in/gp/search?ie=UTF8&camp=1789&creative=9325&index=books&keywords=<?php echo $item_title;?>&linkCode=ur2&tag=<?php echo $amazon_id;?>" target="_blank" class="btn btn-raised btn-danger"><?php echo $amazonlink_mpage;?></a>
<a href="https://librivox.org/search?q=<?php echo $item_title;?>&search_form=advanced" target="_blank" class="btn btn-raised btn-danger">FREE DOWNLOAD</a>
<?php endif; ?>
